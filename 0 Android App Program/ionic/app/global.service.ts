...
interface DataBle {
  ...
  bleReconnectedSubject: BehaviorSubject<boolean>; // 추가됨
  bleReconnected$: Observable<boolean>; // 추가됨
}
...
export class GlobalService {
  ...
  ble: DataBle = {
    ...
    bleReconnectedSubject: new BehaviorSubject<boolean>(false), // 구현됨
    bleReconnected$: new BehaviorSubject<boolean>(false).asObservable() // 구현됨
  };
